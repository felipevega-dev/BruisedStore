          ...
          <div className="space-y-6">
            ...
            <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
              <div className="flex items-center justify-between">
                <div>
                  <h3 className="text-xl font-bold text-red-100">Activar Música</h3>
                ...
                <label className="relative inline-flex cursor-pointer items-center">
                  ...
                  />
                  <div className="peer h-8 w-14 rounded-full border-4 border-red-900 bg-gray-700 after:absolute after:left-[4px] after:top-[4px] after:h-5 after:w-5 after:rounded-full after:border after:border-gray-300 after:bg-white after:transition-all after:content-[''] peer-checked:bg-red-600 peer-checked:after:translate-x-full peer-checked:after:border-white peer-focus:outline-none"></div>
                </label>
              </div>
            </div>
            ...
            {/* Play Mode */}
            <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
              <h3 className="mb-4 text-xl font-bold text-red-100">
                ...
                <button
                  ...
                  className={`rounded-lg border-4 px-4 py-3 font-bold transition-all ${
                    settings.playMode === "single"
                      ...
                      : "border-red-900 bg-red-950/30 text-red-100 hover:bg-red-900/30"
                  }`}
                >
                  Una vez
                </button>
            ...
            <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
              ...
              <label className="flex cursor-pointer items-center justify-center gap-3 rounded-lg border-4 border-dashed border-red-900 bg-red-950/20 py-8 transition-all hover:border-red-600 hover:bg-red-950/30">
                {uploading ? (
                  <>
                    <Loader2 className="h-6 w-6 animate-spin text-red-500" />
                    <span className="font-bold text-red-100">Subiendo...</span>
                  </>
                ) : (
                  <>
            ...
            <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
              ...
              {settings.tracks.length === 0 ? (
                <div className="rounded-lg border-2 border-red-900/30 bg-red-950/20 p-8 text-center">
                  <Music className="mx-auto mb-3 h-12 w-12 text-red-600/50" />
                ...
                <div className="space-y-3">
                  {settings.tracks.map((track, index) => (
                    <div
                      ...
                      className={`flex cursor-move items-center gap-3 rounded-lg border-2 bg-red-950/20 p-4 transition-all ${
                    ...
                    >
                      {/* Número de orden */}
                      <div className="flex h-8 w-8 flex-shrink-0 items-center justify-center rounded-full border-2 border-red-900 bg-red-950/50 text-sm font-bold text-red-100">
                        {index + 1}
                      </div>
                      ...
                      <button
                        ...
                        className="flex-shrink-0 rounded-full border-2 border-red-900 bg-red-950/50 p-2 text-red-100 transition-all hover:bg-red-600 hover:text-white"
                      >
                      ...
                      <div className="flex-1 min-w-0">
                        <input
                          ...
                          className="w-full rounded border-2 border-red-900/30 bg-transparent px-2 py-1 font-bold text-red-100 focus:border-red-600 focus:outline-none"
                        />
                      ...
                      <div className="flex gap-2">
                        ...
                        <button
                          ...
                          className="rounded-lg border-2 border-red-900 bg-red-950/50 p-2 text-red-400 transition-all hover:bg-red-600 hover:text-white"
                        >
            ...
            <div className="sticky bottom-4 flex justify-end">
              <button
                onClick={handleSave}
                disabled={saving}
                className="flex items-center gap-2 rounded-lg border-4 border-white bg-red-600 px-8 py-3 font-black text-white shadow-[8px_8px_0px_0px_rgba(255,255,255,0.3)] transition-all hover:translate-x-1 hover:translate-y-1 hover:bg-red-700 hover:shadow-none disabled:cursor-not-allowed disabled:opacity-50"
              >
                {saving ? (
