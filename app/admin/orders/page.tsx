      ...
      <div className="container mx-auto px-4 sm:px-6 lg:px-8">
        ...
        <div className="mb-8 rounded-2xl border-4 border-black bg-linear-to-r from-purple-500 to-purple-600 p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center gap-3">
            <Link
              href="/admin"
              className="text-white transition-colors hover:text-purple-100"
            >
            ...
            <div>
              ...
              <p className="text-purple-100 font-semibold">Obras a pedido</p>
            </div>
          </div>
        </div>
                  ...
                  >
                    ...
                    {isNew && (
                      <div className="absolute -right-2 -top-2 z-10 animate-pulse">
                        <span className="inline-flex items-center gap-1 rounded-full border-4 border-black bg-orange-400 px-3 py-1 text-xs font-black text-black shadow-[2px_2px_0px_0px_rgba(0,0,0,1)]">
