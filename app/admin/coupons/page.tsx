        ...
        <div className="mb-8 rounded-2xl border-4 border-black bg-linear-to-r from-amber-500 to-amber-600 p-6 shadow-[8px_8px_0px_0px_rgba(0,0,0,1)]">
          <div className="flex items-center justify-between">
            ...
            <button
              ...
              className="flex items-center gap-2 rounded-xl border-4 border-white bg-white px-6 py-3 font-bold text-amber-600 shadow-[4px_4px_0px_0px_rgba(255,255,255,0.5)] transition-all hover:shadow-[2px_2px_0px_0px_rgba(255,255,255,0.5)]"
            >
