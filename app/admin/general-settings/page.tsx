      ...
      <div className="container mx-auto max-w-5xl px-4">
        ...
        <div className="mb-8 flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link
              href="/admin"
              className="rounded-lg border-2 border-red-900 bg-red-950/50 p-2 text-red-100 transition-all hover:bg-red-900"
            >
          ...
          <button
            onClick={handleSave}
            disabled={saving}
            className="flex items-center gap-2 rounded-lg border-2 border-red-600 bg-red-600 px-6 py-3 font-bold text-white transition-all hover:bg-red-700 disabled:opacity-50"
          >
            {saving ? (
              <>
        ...
        <div className="space-y-6">
          ...
          <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-red-100">PWA y App</h2>
            </div>
            ...
            <label className="flex items-center gap-3">
              <input
                ...
                className="h-5 w-5 rounded border-red-900 bg-gray-900 text-red-600 focus:ring-2 focus:ring-red-600"
              />
              <div>
                <span className="font-bold text-red-100">Mostrar Prompt de Instalación PWA</span>
                <p className="text-sm text-red-300">
          ...
          <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-red-100">Paleta de Colores</h2>
            </div>
              ...
              <div>
                ...
                <div className="flex items-center gap-2">
                  <input
                    ...
                    className="h-12 w-16 cursor-pointer rounded border-2 border-red-900"
                  />
                  <input
                    type="text"
                    value={settings.primaryColor}
                    ...
                    className="flex-1 rounded border-2 border-red-900 bg-gray-900 px-3 py-2 text-red-100"
                    placeholder="#DC2626"
                  />
                </div>
              </div>
          ...
          <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-red-100">Información de Contacto</h2>
            </div>
          ...
          <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
            <div className="mb-4 flex items-center gap-3">
              ...
              <h2 className="text-xl font-bold text-red-100">Redes Sociales</h2>
            </div>
          ...
          {/* Footer Settings */}
          <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
            <h2 className="mb-4 text-xl font-bold text-red-100">Footer</h2>
          ...
          {/* Banner Settings */}
          <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
            <h2 className="mb-4 text-xl font-bold text-red-100">Banner / Hero</h2>
          ...
          {/* UI Preferences */}
          <div className="rounded-lg border-2 border-red-900 bg-black/60 p-6 backdrop-blur-sm">
            <h2 className="mb-4 text-xl font-bold text-red-100">Preferencias de UI</h2>
            ...
            <div className="space-y-4">
              <label className="flex items-center gap-3">
                ...
                />
                <div>
                  <span className="font-bold text-red-100">Habilitar Animaciones</span>
                  <p className="text-sm text-red-300">
